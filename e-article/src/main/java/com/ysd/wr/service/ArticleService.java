...
import com.ysd.wr.mapper.ArticleMapper;
import com.ysd.wr.mapper.TagsMapper;
...
public class ArticleService {
    ...
    public List<Article> getArticleByState(Integer state, Integer page, Integer count,Long uid,String keywords) {
    ...
    public Article getArticleById(Long aid) {
        ...
        System.out.println("getArticleById(userid):"+userid+"Article"+article);
	...
	public List<Article> getAllArticle(Long uid) {
		...
		return  articleMapper.getAllArticle(uid);		
	}
